...
| Base de desenvolvimento humano | `IDH.csv` | Indicadores de escolaridade, educação e IDH | https://hdr.undp.org/data-center/documentation-and-downloads | INSERIR | INSERIR |
